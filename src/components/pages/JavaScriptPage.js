    ...
    return (
      <div>
          ...
          <main className={'roadmapPageMain'}>
              ...
              <p>
                  JavaScript is a dynamic scripting language used primarily for enhancing web pages with interactive and responsive features. It enables developers to create engaging user experiences, handle user input, manipulate HTML and CSS elements, and make asynchronous requests to servers. JavaScript is essential for modern web development, allowing websites to offer dynamic content, real-time updates, and interactive functionalities</p>
